<%-- 
    Document   : feedbackFilter
    Created on : 02-Feb-2014, 10:51:46
    Author     : Girjesh
--%>
...
<html>
    ...
    <body>
        ...
        <h1>&nbsp;</h1>
        <div  style=" margin-left:auto; margin-right:auto; margin-top: auto; width:1055px;">
         ...
         <div style="width:400px;position: relative; clear:both; margin-left: auto; margin-right: auto; margin-top: 40px;">
            <form id="form1" name="form1" method="post" action="FeedbackFilterServlet">
                
                  <fieldset>  
                <legend style="color:#006699;font-size: 22px " align="center">Select Options </legend>
                 <%   if(deptId== null)
                   {%>
                   <div style="position:relative; float: left;width: 170px; margin-top: 40px;">
                ...
                <select name="batch" id="year" style="width:220px;">
                  ...
                  <%
                        ...
                        <div style="position:relative;width: 400px; " align="center">
                            <input type="submit" name="button" id="generateFeedback" value="filter" align="center" />  
                        </div>             
            </fieldset>
